...
An important data type for large scale data processing is the key/value pair. The Dataflow SDKs use the class `KV` to represent key/value pairs.
...
https://cloud.google.com/dataflow/model/pcollection#bounded-and-unbounded-pcollections