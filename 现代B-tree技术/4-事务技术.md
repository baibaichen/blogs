...
The traditional techniques described here are sufficient for small updates but it remains **unadvisable** to perform bulk insertions or deletion while concurrently **modifying the physical database design** with index creation and removal. <u>There are two principal designs: either the concurrent updates are applied to the structure still being built or these updates are captured elsewhere and applied after the main index creation activity is complete</u>. These designs have been called the “no side file” and “side file” [98]. The recovery log may serve as the “side file.” 
